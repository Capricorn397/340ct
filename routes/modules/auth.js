...
const refreshToken = (token) => {
	const query = `UPDATE login_token SET expiry_time = NOW() + interval '15 minutes' WHERE token = '${token}' AND expiry_time NOT NULL AND expiry_time < NOW() + interval '15 minutes'`
